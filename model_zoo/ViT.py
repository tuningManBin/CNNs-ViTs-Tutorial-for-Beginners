...
class ParchEmbedding(nn.Module):
    ...
    """
    def __init__(self, in_channels: int, image_size: int, patch_size: int, embedding_dim: int, drop_rate: float = 0.1):
        """
        Arguments:
...
class SelfAttention(nn.Module):
    ...
    """
    def __init__(self, embedding_dim: int, num_heads: int, attn_drop_rate: float = 0.1, proj_drop_rate: float = 0.1):
        """
        Arguments:
            embedding_dim (int): the dimensions of embedding
...
class MLP(nn.Module):
    ...
    def __init__(self, input_dim: int, hidden_dim: Optional[int] = None, output_dim: Optional[int] = None,
                 activation: Type[nn.Module] = nn.GELU, drop_rate: float = 0.1):
        """
        Arguments:
