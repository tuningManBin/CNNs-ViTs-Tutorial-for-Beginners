...
class WideResNet(nn.Module):
    ...
    def __init__(self, num_blocks, in_channels, widen_factor, num_features, pool_stride,
                 logits, dataset, normalize, feature_size=1, basic_block=BasicBlock, return_feature_map=False):
        """
        Arguments:
            ...
            logits (int): the dimensionality of output vector
        ...
        self.project = nn.Linear(feature_size ** 2 * 4 * num_features * widen_factor, logits)
